  ...
  onShow: function () {
    ...
    api.getProdectDetail({
      success: (res) => {
        ...
        storgeData['zhidaojia'] = info.zhidaojia.value;
        storgeData['title'] = info.title.value;
        storgeData['yuegong'] = info.yuegong.value;
        storgeData['shoufu'] = info.shoufu.value;
        storgeData['fenqi'] = info.fenqi.value;
        storgeData['imgs'] = [];
        var imgArr = info.image.option_value;
        for(var i = 0;i<imgArr.length;i++){
          storgeData['imgs'].push(imgUrl + imgArr[i].value)
        }
        that.setData({
